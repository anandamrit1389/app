...
const ProfiledHeader = () => {
  ...
  return (
    <div
      className={cn(
        'relative flex h-[64px] items-center justify-center py-[18px] md:flex-row-reverse md:justify-between',
        { 'bg-[#fff] px-4': isMobile },
      )}
    >
      {isMobile ? (
        <BaseButton
          ...
          variant="ghost"
          size="sm"
          classNames="absolute top-1/2 left-4 -translate-y-1/2 p-0"
          icon={<ArrowLeftIcon />}
        />
      ) : (
        <BaseButton
